        ...
        {option.values?.map((v) => {
          ...
          return (
            <button
              ...
              key={v.value}
              className={clx(
                "border-ui-border-base bg-ui-bg-subtle border text-small-regular font-semibold h-10 rounded-rounded p-2 flex-1 ",
                {
                  "border-mysRed-100 border-2 font-semibold": current === v.value,
