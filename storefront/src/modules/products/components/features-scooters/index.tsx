...
export const ProductTechnicalSpecifications: React.FC<ProductTechnicalSpecificationsProps> = ({ product }) => {
  ...
  return (
    <section className="max-w-5xl mx-auto p-6 sm:p-10 bg-white rounded-2xl shadow-md mt-20">
      <div className="text-center mb-10">
        <h2 className="text-3xl sm:text-4xl font-black uppercase text-gray-800 tracking-wide font-archivoBlack">
          {mainTitle}
        </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        {mappedCharacteristics.map((char, idx) => {
          ...
          return (
            <div
              key={idx}
              className="flex flex-col items-center justify-center bg-gray-50 rounded-xl p-4 text-center transition hover:shadow-md"
            >
              <FontAwesomeIcon icon={Icon} className="text-mysGreen-100 w-8 h-8 mb-3" />
