...
const FinancingFilters = ({
  ...
  const hasActiveFilters =
    ...
    filters.contacted ||
    filters.searchTerm ||
    !filters.showCancelledDelivered;

  return (
    <div className="px-6 py-4 dark:bg-[#212124] bg-gray-50">
      <div className="flex items-center gap-2 mb-4">
        <Filter className="w-4 h-4 text-gray-500" />
        <Text className="font-medium text-gray-700 dark:text-gray-400">Filtros</Text>
      ...
      <div className="mt-3 flex items-center">
        <ShowCancelledFilter
          ...
          onChange={(showCancelledDelivered) =>
            onFiltersChange({ showCancelledDelivered })
          }
        />
      </div>
    </div>
