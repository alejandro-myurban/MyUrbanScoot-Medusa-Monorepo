              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-start mb-1">
                    {/* Contenedor del nombre y la hora: Permite que el nombre se trunque y la hora se quede a la derecha */}
                  ...
                  {/* Estado y departamento: Contenedor con `flex-wrap` para que salten de línea si es necesario */}
