...
  return (
    <div
      className={`flex items-start gap-3 animate-fade-in-up w-full overflow-hidden ${
...
      )}
      <div
        className={`max-w-[90%] md:max-w-xl rounded-lg p-3 shadow-md transition-all duration-400 hover:shadow-lg break-all overflow-hidden ${
          isAssistant
...
        {isOptionsMessage ? (
          <>
            <Text className="mb-2 whitespace-pre-wrap transition-all duration-400 hover:text-gray-700 dark:hover:text-gray-300 break-all">{messageLines[0]}</Text>
...
        ) : (
          <>
            {textMessage && <Text className="whitespace-pre-wrap transition-all duration-400 hover:text-gray-700 dark:hover:text-gray-300 break-all">{textMessage}</Text>}
            {isImageMessage && (
              <div className="flex flex-col items-start gap-2 mt-2 animate-fade-in overflow-hidden">
                <a 
                  href={imageUrl!} 
                  target="_blank" 
