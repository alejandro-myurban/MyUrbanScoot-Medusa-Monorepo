...
// Se agregó el profile_name a las props
type ChatBubbleProps = ChatMessage & {
  profile_name?: string;
};

export const ChatBubble = ({ message, role, status, created_at, profile_name }: ChatBubbleProps) => {
...
  
  // Actualizamos la etiqueta del remitente para usar el nombre del perfil si existe
  if (isAgent) {
    senderLabel = "Agente";
